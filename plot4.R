...
## Now create plot, 4 x 4 plot, set this using par, using mfrow, so fills rows first
png("plot4.png", width=480, height=480)
par(mfrow = c(2, 2))
plot(power_select$DateTime, power_select$Global_active_power, type="l", ylab="Global Active Power", xlab="")
plot(power_select$DateTime, power_select$Voltage, type="l", ylab="Voltage", xlab="datetime")
...
plot(power_select$DateTime, power_select$Global_reactive_power, type="l", ylab="Global_reactive_power", xlab="datetime")
dev.off()
